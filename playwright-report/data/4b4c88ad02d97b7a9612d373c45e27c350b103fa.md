  ...
  - complementary [ref=e5]:
    - generic [ref=e6]:
      ...
      - menu [ref=e20]:
        ...
        - menuitem "check-square Задачи" [active] [ref=e46] [cursor=pointer]:
    ...
    - main [ref=e187]:
      - generic [ref=e188]:
        - generic [ref=e189]:
          - generic [ref=e190]:
            - generic [ref=e191]:
              - heading "Задачи" [level=4] [ref=e193]
              - generic [ref=e195]: (0)
            - button "plus Создать задачу" [ref=e198] [cursor=pointer]:
              - img "plus" [ref=e200]:
                - img [ref=e201]
              - generic [ref=e204]: Создать задачу
          - generic [ref=e205]:
            - generic [ref=e210]:
              - searchbox "Поиск..." [ref=e212]
              - button "search" [ref=e215] [cursor=pointer]:
                - img "search" [ref=e217]:
                  - img [ref=e218]
            - generic [ref=e221]:
              - button "loading" [ref=e223]:
                - img "loading" [ref=e225]:
                  - img [ref=e226]
              - button "download" [ref=e229] [cursor=pointer]:
                - img "download" [ref=e231]:
                  - img [ref=e232]
        - generic [ref=e235]:
          - generic:
            - generic:
              - generic:
                - generic:
                  - table:
                    - rowgroup:
                      - row "Задача Этап Приоритет Ответственные Срок Действия":
                        - columnheader
                        - columnheader "Задача":
                          - generic:
                            - generic: Задача
                            - generic:
                              - generic:
                                ...
                                - img:
                                  - img
                        - columnheader "Этап"
                        - columnheader "Приоритет"
                        - columnheader "Ответственные"
                        - columnheader "Срок":
                          - generic:
                            - generic: Срок
                            - generic:
                    ...
                    - rowgroup:
                      - row "inbox Нет задач Создайте первую задачу":
                        - cell "inbox Нет задач Создайте первую задачу":
                          - generic:
                            - generic:
                              - img "inbox":
                                - img
                            - generic:
                              - generic:
                                - generic: Нет задач
                                - generic: Создайте первую задачу
```