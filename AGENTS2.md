AGENTS.md — Руководство для фронтенд‑разработки (Next.js + Ant Design) с полным покрытием функционала Enterprise CRM API
...
Этот AGENTS.md регламентирует подход для полного покрытия функционала Enterprise CRM API на фронтенде с использованием Next.js и Ant Design. Следуйте ему для единообразия, качества и масштабирумости проекта.
