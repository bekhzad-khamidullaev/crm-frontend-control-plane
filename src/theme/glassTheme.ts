...
type UseGlassThemeOptions = {
  algorithm?: ConfigProviderProps['theme'] extends { algorithm?: infer T } ? T : undefined;
};
...
const useGlassTheme = (options: UseGlassThemeOptions = {}) => {
  const { styles } = useStyles();
  const algorithm = options.algorithm || theme.defaultAlgorithm;
