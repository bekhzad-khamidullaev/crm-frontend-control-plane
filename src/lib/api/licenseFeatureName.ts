const FEATURE_NAME_KEYS: Record<string, string> = {
  ...
  'business_processes': 'licenseFeatures.businessProcesses',
  'business_processes.base': 'licenseFeatures.businessProcessesBase',
  'business_processes.transitions': 'licenseFeatures.businessProcessesTransitions',
  'business_processes.sla': 'licenseFeatures.businessProcessesSla',
  'business_processes.analytics': 'licenseFeatures.businessProcessesAnalytics',
  ...
  'ai.assist': 'licenseFeatures.aiAssist',
  ...
  'documents.contracts_generation': 'licenseFeatures.documentsContractsGeneration',
};
...
const FEATURE_FALLBACK_NAMES: Record<string, string> = {
  ...
  'business_processes.base': 'Business Processes Base',
  'business_processes.transitions': 'Business Process Transitions',
  'business_processes.sla': 'Business Process SLA',
  'business_processes.analytics': 'Business Process Analytics',
  ...
  'documents.contracts_generation': 'Contract Generation',
};
